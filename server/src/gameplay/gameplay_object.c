...
** Last update Sun Jul 13 22:05:15 2014 otoshigami
*/
						    ...
						    t_player_command* command)
{
  ...
  if (command->player->death_time.tv_sec == 0)
    ;
  if (command->player->death_time.tv_usec == 0)
    ;
  if (this->time.tv_sec == 0)
    ;
  if (this->time.tv_usec == 0)
    ;
